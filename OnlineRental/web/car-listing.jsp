<%-- 
    Document   : car-listing
    Created on : 4 Jun, 2020, 2:24:39 PM
    Author     : vinit
--%>
...
<%!     Connection con=null;
    ...
    ResultSet rs=null;
    int  modelYear=0,seatingCapacity=0,pricePerDay=0,cnt=0,id=0;
    String fuelType=null;
    String vehicleTitle=null,brandName=null,vehicleOverview=null,image=null;
%>
...
?>
              --%>
<p><span><%=cnt%>Listings</span></p>
</div>
</div>
<%
    try {
   String query ="SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
...
--  */   %>
        <div class="product-listing-m gray-bg">
            <div class="product-listing-img"><img src="admin/img/vehicleimages/<%=image%>" class="img-responsive" alt="Image" /> </a> 
          </div>
          <div class="product-listing-content">
              <h5><a href="vehicle-details.jsp?vhid=<%=id%>"><%=vehicleOverview%> ,<%=vehicleTitle%></a></h5>
            <p class="list-price">$<%=pricePerDay%> Per Day</p>
            <ul>
            ...
            <a href="vehicle-details.jsp?vhid=<%=id%>" class="btn">View Details <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <%     }
           }catch(Exception e){
